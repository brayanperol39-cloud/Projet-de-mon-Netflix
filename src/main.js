...
const objectConfigs = [
  { file: '19e20310_base_basic_pbr.glb', x:  0.0, y: 1.60, z: -3.0, s: 0.5, ry: 0.0,  fa: 0.12, fs: 0.80, filmTitle: 'Dracula' },
  { file: '2963748f_base_basic_pbr.glb', x: -3.5, y: 1.55, z: -5.0, s: 0.5, ry: 0.5,  fa: 0.15, fs: 0.65, filmTitle: 'Vampire Diaries' },
  { file: '3d06ccb6_base_basic_pbr.glb', x:  3.5, y: 1.65, z: -5.5, s: 0.5, ry: 1.0,  fa: 0.10, fs: 0.90, filmTitle: 'Legacies' },
  { file: '4a72bdf2_base_basic_pbr.glb', x: -5.0, y: 1.50, z: -2.0, s: 0.5, ry: 0.3,  fa: 0.18, fs: 0.70, filmTitle: 'Twilight' },
  { file: '642cf26c_base_basic_pbr.glb', x:  5.0, y: 1.60, z: -1.5, s: 0.5, ry: 0.8,  fa: 0.13, fs: 0.75, filmTitle: 'V Wars' },
  { file: '68053380_base_basic_pbr.glb', x: -7.0, y: 1.70, z:  0.5, s: 0.5, ry: 1.2,  fa: 0.14, fs: 0.85, filmTitle: 'Abraham Lincoln: Vampire Hunter' },
  { file: '8b55883e_base_basic_pbr.glb', x:  7.0, y: 1.55, z:  0.0, s: 0.5, ry: 0.6,  fa: 0.11, fs: 0.95, filmTitle: 'Sinners' },
  { file: '8f5fc837_base_basic_pbr.glb', x: -2.5, y: 1.65, z: -7.0, s: 0.5, ry: 1.8,  fa: 0.16, fs: 0.60, filmTitle: 'Serment de Minuit' },
  { file: '909e698a_base_basic_pbr.glb', x:  2.5, y: 1.60, z: -7.0, s: 0.5, ry: 2.1,  fa: 0.12, fs: 1.00, filmTitle: 'Van Helsing' },
  { file: 'b573e801_base_basic_pbr.glb', x: -6.0, y: 1.50, z: -5.5, s: 0.5, ry: 0.9,  fa: 0.20, fs: 0.55, filmTitle: 'Morbius' },
  { file: 'c81f3a64_base_basic_pbr.glb', x:  6.0, y: 1.70, z: -4.5, s: 0.5, ry: 1.5,  fa: 0.15, fs: 0.80, filmTitle: 'Penny Deadful' },
  { file: 'dbc31598_base_basic_pbr.glb', x:  0.0, y: 1.60, z:  4.5, s: 0.5, ry: 0.2,  fa: 0.13, fs: 0.70, filmTitle: 'Morbius' },
  { file: 'e2b4c756_base_basic_pbr.glb', x: -4.0, y: 1.55, z:  3.0, s: 0.5, ry: 1.7,  fa: 0.17, fs: 0.75, filmTitle: 'Blade' },
  { file: 'fea72906_base_basic_pbr.glb', x:  4.0, y: 1.65, z:  2.5, s: 0.5, ry: 0.4,  fa: 0.11, fs: 0.85, filmTitle: 'True Blood' },
